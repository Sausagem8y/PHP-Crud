VALUES ('" . mysqli_escape_string($conn, $title) . "','"
               ...
               /**Article
 * 
 * a piece of writing for the application.
 */
...
class Article {
    ...
    public $content;
    /**
     * Its supposed to be date and time but its a bit finiky.
     * @var datetime
     */
    public $published_at;
    /**
...
/**
 * get a pageof articles.
 * 
 * @param object $conn Connection to the database
 * @param integer $limit Number of records to return
 * @param integer $offset Numberof records to skip
 * 
 ...
 */
    ...
    /**
     * Get the article record based on th ID along with associated categories, if any.
     * 
     * @param object $conn Connection to the database
     * @param integer $id the article ID
     * 
     * @return array The article data with catagories
     */
 ...
 */
     ...
     * 
     * @param object $conn cenect to the database
...
/**
 * Deletes the current <article class="
 * @param object $conn Connection to the database.
 * 
